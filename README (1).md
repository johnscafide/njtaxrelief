# NJPTR Watchdog platform release 0.16.1
...
Release 0.16.1 repairs the Developer/paid-account post-login Dashboard path by guarding a Pro-only percentile renderer until its lazy module has loaded. Dashboard and Home now keep a single Supabase auth owner; standalone Data Center alone opts into plan-context session discovery. It includes all 0.16.0 progressive-disclosure, View As, Data Center, marker-backlog and SaaS-pipeline work.
...
- 324-marker catalog with Standard / Pro / Pro+ and profession tagging
