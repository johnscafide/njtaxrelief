...
5. Test Pro and Pro+ with Stripe test mode before adding live secrets.
6. Only after test-mode entitlement transitions pass should live paid access be enabled.
