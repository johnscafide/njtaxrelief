...
values
('njplus.nj-dca-new-home-warranty.new_home_warranty_enrollments', array['county'], 'workbench-hydrate', 'live', array['NJ DCA New Home Warranties Q4 2025 preliminary'], now(), 'Authenticated production canary passed on Atlantic County control property; DCA Number of new houses is exposed as warranty enrollments. 2026 Q1 source links remain 404.', 'authoritative_reference', array['Number of new houses'], null, 7776000, 'versioned_snapshot', true),
('njplus.nj-dca-new-home-warranty.new_home_warranty_average_price', array['county'], 'workbench-hydrate', 'live', array['NJ DCA New Home Warranties Q4 2025 preliminary'], now(), 'Authenticated production canary passed; value is the published DCA county average sales price.', 'authoritative_reference', array['Average sales price'], null, 7776000, 'versioned_snapshot', true),
('njplus.nj-dca-new-home-warranty.new_home_warranty_median_price', array['county'], 'workbench-hydrate', 'live', array['NJ DCA New Home Warranties Q4 2025 preliminary'], now(), 'Authenticated production canary passed; value is the published DCA county median sales price.', 'authoritative_reference', array['Median sales price'], null, 7776000, 'versioned_snapshot', true),
('njplus.nj-dca-new-home-warranty.new_home_warranty_sales_count', array['county'], 'workbench-hydrate', 'live', array['NJ DCA New Home Warranties Q4 2025 preliminary'], now(), 'Authenticated production canary passed; the DCA quarterly table reports Number of new houses for the warranty-covered new-home sales table.', 'authoritative_reference', array['Number of new houses'], null, 7776000, 'versioned_snapshot', true),
('njplus.nj-dca-new-home-warranty.new_home_warranty_quarter', array['county'], 'workbench-hydrate', 'live', array['NJ DCA New Home Warranties Q4 2025 preliminary'], now(), 'Authenticated production canary passed; report header quarter is exposed explicitly so consumers can see the source vintage.', 'authoritative_reference', array['Report header quarter'], null, 7776000, 'versioned_snapshot', true),
('njplus.nj-dca-new-home-warranty.new_home_warranty_year', array['county'], 'workbench-hydrate', 'live', array['NJ DCA New Home Warranties Q4 2025 preliminary'], now(), 'Authenticated production canary passed; report header year is exposed explicitly so consumers can see the source vintage.', 'authoritative_reference', array['Report header year'], null, 7776000, 'versioned_snapshot', true),
('njplus.nj-dca-new-home-warranty.new_home_warranty_price_change', array['county'], 'workbench-hydrate', 'live', array['NJ DCA New Home Warranties Q3 2025 preliminary','NJ DCA New Home Warranties Q4 2025 preliminary'], now(), 'Authenticated production canary passed; exact Q3-to-Q4 percentage change in published county average sales price, rounded to two decimals.', 'derived_governed', array['Average sales price'], 'nhw-q3-q4-2025-average-price-change-v1', 7776000, 'versioned_snapshot', true),
('njplus.nj-dca-new-home-warranty.new_home_warranty_enrollment_change', array['county'], 'workbench-hydrate', 'live', array['NJ DCA New Home Warranties Q3 2025 preliminary','NJ DCA New Home Warranties Q4 2025 preliminary'], now(), 'Authenticated production canary passed; exact Q3-to-Q4 percentage change in DCA Number of new houses, rounded to two decimals.', 'derived_governed', array['Number of new houses'], 'nhw-q3-q4-2025-enrollment-change-v1', 7776000, 'versioned_snapshot', true),
('njplus.nj-dca-new-home-warranty.new_home_warranty_county_rank', array['county'], 'workbench-hydrate', 'live', array['NJ DCA New Home Warranties Q4 2025 preliminary'], now(), 'Authenticated production canary passed; exact Watchdog ordinal rank across the 21 published county Number of new houses values. DCA-published average/median price ranks are not substituted for this marker.', 'derived_governed', array['Number of new houses'], 'nhw-q4-2025-enrollment-rank-v1', 7776000, 'versioned_snapshot', true),
('njplus.nj-dca-new-home-warranty.new_home_warranty_municipal_rank', array['county'], 'workbench-hydrate', 'unavailable', array['NJ DCA New Home Warranties quarterly reports'], now(), 'Official DCA quarterly New Home Warranty data is county-level and does not publish municipality-level warranty enrollment rank. Authenticated canary verifies source_checked_no_value; do not synthesize a municipality rank.', 'authoritative_reference', array[]::text[], null, 7776000, 'versioned_snapshot', false)
