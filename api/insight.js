...
module.exports=async function handler(req,res){
  ...
  const author={'@type':'Organization','@id':WATCHDOG_ORG,'name':'Watchdog','alternateName':'Watchdog Property Intelligence','url':WATCHDOG_ORIGIN+'/'};
  const articleSchema={
