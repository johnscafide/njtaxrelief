...
def nav() -> str:
    return '''<header class="tp-nav"><a class="tp-brand" href="/"><span>NJ</span> Property Tax Relief</a><nav aria-label="Primary navigation"><a href="/towns/">Town reports</a><a href="/anchor-estimator.html">Benefit estimator</a><a href="/property/">Watchdog</a></nav><a class="tp-nav-cta" href="/property/pro.html#plans">See Watchdog plans</a></header>'''
