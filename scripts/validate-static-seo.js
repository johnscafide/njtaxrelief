...
for(const need of ['/btc.html','/leadiq.html','/qscore.html','/property/insights/admin.html','/property/data-workbench','/property/data-center','/property/growth/(.*)'])if(!noindexPaths.has(need))errors.push('missing X-Robots-Tag noindex '+need);
