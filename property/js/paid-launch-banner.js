...
#wd-paid-launch-hero{box-sizing:border-box;position:relative;z-index:4;width:min(430px,100%);margin:14px auto 0;color:#fff;font-family:var(--font-ui,"Plus Jakarta Sans",Arial,sans-serif);pointer-events:auto}\
...
@media(max-width:768px){#wd-paid-launch-banner .wdpl-inner{min-height:54px;padding:7px 48px 7px 14px;justify-content:flex-start;gap:9px}#wd-paid-launch-banner .wdpl-copy{display:block;font-size:.75rem}#wd-paid-launch-banner .wdpl-pill{display:none}#wd-paid-launch-banner .wdpl-cta{margin-left:auto;padding:8px 10px;font-size:.75rem;white-space:nowrap}#wd-paid-launch-hero{width:min(430px,100%);margin:12px auto 0}#wd-paid-launch-hero .wdpl-hero-chip{min-height:42px;padding:6px 7px 6px 10px}#wd-paid-launch-hero strong{font-size:10.5px}#wd-paid-launch-hero .wdpl-hero-meta{font-size:9px}#wd-paid-launch-hero .wdpl-get-started{font-size:9.5px;padding:7px 8px}}\
@media(max-width:480px){#wd-paid-launch-hero{width:100%;margin:11px auto 0}#wd-paid-launch-hero .wdpl-hero-chip{border-radius:14px;gap:8px}#wd-paid-launch-hero .wdpl-hero-copy{display:block;white-space:normal}#wd-paid-launch-hero .wdpl-hero-meta{display:block;margin-top:2px}#wd-paid-launch-hero .wdpl-get-started{font-size:9px}}';
