...
// The main-menu ANCHOR Applications link now lives in watchdog-universal-menu.js items(); this runtime only adds the profile row and top icon.
...
function sync(){addStyle();document.querySelectorAll('#wd6-profile nav,#hm27-profile-pop nav,.wd-universal-profile>nav,#wd-profile-content nav').forEach(insertProfile);insertTopIcon()}
