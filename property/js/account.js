(function () {
  ...
  function render() {
    ...
    $('ac-app').innerHTML =
      ...
      '<article class="ac-card"><span>ACCOUNT SECURITY</span><h2>Your account is protected</h2><p>Watchdog checks your account before showing paid tools and data.</p><div class="ac-account-rows"><div><i class="fas fa-envelope"></i><span><small>ACCOUNT EMAIL</small><b>' + esc(user.email || '') + '</b></span></div></div></article></section>' +
