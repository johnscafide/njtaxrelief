(function () {
  ...
  function render() {
    ...
    $('ac-app').innerHTML =
      ...
      '<article class="ac-card ac-account-summary"><span>ACCOUNT</span><h2>Watchdog Account</h2><div class="ac-account-rows"><div><i class="fas fa-envelope"></i><span><small>ACCOUNT EMAIL</small><b>' + esc(user.email || '') + '</b></span></div></div></article></section>' +
