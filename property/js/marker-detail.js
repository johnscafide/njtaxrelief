(function(){
  ...
  Promise.all([
    ...
    var reg=x[0],rich=(x[1].markers||{})[q.get('id')]||{},sources=x[2].datasets||[],formula=(x[3].markers||{})[q.get('id')],m=reg.markers.find(function(v){return v.id===q.get('id');});
