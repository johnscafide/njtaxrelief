...
function show(){if(standalone()||sessionStorage.getItem('wdInstallDismissed'))return;var n=note(isiOS()?'In Safari, tap Share, then “Add to Home Screen.”':'Install for a focused, app-like workspace.');if(!isiOS()){n.querySelector('span').onclick=function(){if(!deferredPrompt)return;deferredPrompt.prompt();deferredPrompt.userChoice.finally(function(){deferredPrompt=null;n.remove();});};}n.querySelector('button').onclick=function(){sessionStorage.setItem('wdInstallDismissed','1');n.remove();};}
