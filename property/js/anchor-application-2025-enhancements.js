...
async function init(){try{loadStyles();await loadPartial();installWelcome();installIncomeGuidance();installParcelGuidance();installPreview();loadEstimateBridge();loadGrowth();}catch(_){loadEstimateBridge();loadGrowth();}}
init();
})();
