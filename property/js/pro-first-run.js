...
.wd-fr-launch{display:inline-flex;align-items:center;gap:8px;border:0;border-radius:999px;padding:10px 14px;background:#10294b;color:#fff;font:700 12px/1.1 "Plus Jakarta Sans",sans-serif;text-decoration:none;box-shadow:0 8px 20px rgba(16,41,75,.14)}\
...
.wd-fr-card{width:min(520px,100%);background:#fff;border-radius:22px;padding:26px;box-shadow:0 28px 80px rgba(0,0,0,.24);color:#10294b;font-family:"Source Sans 3",sans-serif}\
.wd-fr-step{font:800 12px/1.2 "Plus Jakarta Sans",sans-serif;letter-spacing:.08em;text-transform:uppercase;color:#087f82}.wd-fr-card h2{margin:8px 0 10px;font:800 clamp(24px,5vw,34px)/1.08 "Plus Jakarta Sans",sans-serif}.wd-fr-card p{margin:0;color:#52646d;font-size:15px;line-height:1.55}.wd-fr-card ul{margin:16px 0 0;padding-left:20px;color:#40545e;font-size:14px;line-height:1.55}.wd-fr-actions{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-top:22px}.wd-fr-actions button{border:0;border-radius:12px;padding:11px 15px;font:800 12px/1 "Plus Jakarta Sans",sans-serif;cursor:pointer}.wd-fr-skip{background:transparent;color:#687980}.wd-fr-next{background:#10294b;color:#fff}.wd-fr-next:hover{background:#0b203d}@media(max-width:520px){.wd-fr-card{padding:22px 18px}.wd-fr-actions{align-items:stretch;flex-direction:column-reverse}.wd-fr-actions button{width:100%;min-height:44px}}';
