(function () {
  ...
  function insertConnections(app) {
    ...
    section.innerHTML = '<header><div><span>CONNECTIONS</span><h2>CRM &amp; newsletter accounts</h2><p>Save each provider once. Watchdog keeps the credential server-side in its encrypted secret store and reuses that user-scoped connection anywhere the provider is supported.</p></div><a class="ac-connection-center" href="/property/integrations"><i class="fas fa-arrow-up-right-from-square"></i> Integration Center</a></header>' +
      ...
      '<article class="ac-connection-card"><div class="ac-connection-head"><span class="ac-provider-icon ac-provider-boldtrail"><span class="ac-provider-wordmark">BT</span></span><div><small>CRM</small><h3>BoldTrail / kvCORE</h3><p id="ac-crm-status">Checking connection…</p></div></div>' +
      ...
      '<article class="ac-connection-card"><div class="ac-connection-head"><span class="ac-provider-icon ac-provider-kit"><span class="ac-provider-wordmark">kit</span></span><div><small>NEWSLETTER / EMAIL SERVICE</small><h3>Kit</h3><p id="ac-kit-status">Checking connection…</p></div></div>' +
