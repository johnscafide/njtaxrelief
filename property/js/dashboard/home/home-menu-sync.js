...
(function(){
  ...
  function boot(){loadPropertyVisual();loadLiveFix();refreshUniversalMenu();document.addEventListener('watchdog:universal-menu-ready',refreshUniversalMenu,{once:true});var startIntelligence=function(){loadIntelligenceRuntime();};if('requestIdleCallback'in window)requestIdleCallback(startIntelligence,{timeout:500});else setTimeout(startIntelligence,80);}
