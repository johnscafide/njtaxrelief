...
(function(){
  ...
  function enhance(root){
    if(!root)return;
    enhanceSection(root);
    if(root.querySelectorAll)root.querySelectorAll('section.sec').forEach(enhanceSection);
  }
  ...
  function boot(){
    ...
    new MutationObserver(function(records){
      records.forEach(function(record){record.addedNodes.forEach(function(node){if(node.nodeType===1)enhance(node);});});
