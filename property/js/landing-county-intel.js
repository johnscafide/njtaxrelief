...
(function(){
  ...
  function ensureStyles(){
    ...
    style.textContent=[
      ...
      '@media(max-width:680px){.wd-county-intel{padding:18px 0 46px}.wd-county-intel .wd-county-intel-wrap{width:calc(100% - 28px);max-width:1240px}.wd-county-intel-toolbar{margin-bottom:12px}.wd-county-intel-all{font-size:13px}.wd-county-intel-grid{grid-template-columns:1fr;gap:14px}.wd-county-intel-card:last-child{display:block;grid-column:auto}.wd-county-intel-image,.wd-county-intel-card:last-child .wd-county-intel-image{height:170px;min-height:0}.wd-county-intel-copy{padding:18px}.wd-county-intel-card h3{font-size:20px}}',
