...
expect(refresh.includes("setThemeTab(panel,saved.kind)"),'theme tabs do not follow saved type');
...
expect((refresh.match(/kind:'image'/g)||[]).length===10,'expected 10 image presets');
