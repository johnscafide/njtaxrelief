...
assert.match(sync,/auth\.updateUser\(\{data:\{full_name:name\}\}\)/);
assert.match(sync,/form\.addEventListener\('input',identityChanged,true\)/);
assert.match(sync,/new MutationObserver\(sync\)\.observe\(form/);
