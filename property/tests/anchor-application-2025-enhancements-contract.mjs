...
assert.ok(enhancements.includes('input[name="income_\'+year+\'.a"]'), 'PAS worksheet must target each year-specific line a field');
assert.match(enhancements,/\['a','b','c','d','e'\]\.reduce/);
