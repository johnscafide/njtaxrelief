...
| WCR-NIST-001 | NIST CSF 2.0 Current/Target Profile | NIST CSF 2.0, SOC 2, ISO 27001 | Implemented | `property/docs/compliance/NIST-CSF-2-PROFILE.md` | Add Category/Subcategory mappings, named control owners and a formal risk register. |
...
| WCR-SDLC-002 | Application security contracts / ASVS readiness | SOC 2 Security, OWASP ASVS 5.0.0 Level 2, NIST Protect | Partial | `property/tests/security-contracts.mjs`, `property/docs/compliance/ASVS-5-L2-BASELINE.md` | Complete requirement-level applicability/evidence mapping across the ASVS Level 2 set, beginning with auth/session/authorization/OAuth. |
...
| WCR-PRIV-001 | Privacy notice and consumer rights | NJDPA, SOC 2 Privacy, ISO 27701 | Partial | `property/privacy/index.html`, `property/docs/compliance/NJDPA-DATA-PROTECTION-ASSESSMENT.md` | Reconcile the public policy's overbroad description of NJDPA sensitive financial data, then perform periodic data-inventory-to-policy reconciliation. |
...
| WCR-PRIV-003 | Data protection assessment discipline | NJDPA, SOC 2 Privacy, ISO 27701 | Partial | `property/docs/compliance/NJDPA-DATA-PROTECTION-ASSESSMENT.md` | Add assessments/addenda before material AI profiling, marketing automation, voice/ISA or new high-risk personal-data processing goes live. |
...
| WCR-TRUST-001 | Public security/trust transparency | Consumer transparency, SOC 2 communication support | Implemented | `property/trust/index.html`, `property/tests/seven-readiness-contracts.mjs` | Link the Trust Center from shared public footer/legal surfaces and keep every public claim evidence-backed. |
...
9. ASVS Level 2 applicability/evidence mapping is substantially complete.
