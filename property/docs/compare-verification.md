# Watchdog comparison verification

Comparison pages are factual marketing claims about third-party products. Re-check them quarterly against each vendor's official pricing/product documentation.

## Quarterly checklist

Review `/property/compare/` pages for PropStream, ATTOM, PropertyShark, Regrid, PropertyRadar and BatchData.

For each vendor:

1. Verify current public plan names and prices where published.
...
Do not infer unpublished competitor pricing. If a vendor only quotes privately, say so.

## Current baseline

Last full baseline review: August 2026.
