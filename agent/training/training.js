(function(){
  ...
  document.addEventListener('click',function(e){var r=e.target.closest('[data-review]');if(r){review(r.getAttribute('data-review'));return}var p=e.target.closest('[data-prev]');if(p)show(p.getAttribute('data-prev'))});
